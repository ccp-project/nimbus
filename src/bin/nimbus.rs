...
use ccp_nimbus::{DelayMode, FlowMode, LossMode, Nimbus};
...
fn make_args() -> Result<(ccp_nimbus::NimbusConfig, String), String> {
    let matches = clap::App::new("CCP NIMBUS")
        ...
        .arg(
            Arg::with_name("use_switching")
                .long("use_switching")
                .default_value("false")
                .help(""),
        )
        .arg(
            Arg::with_name("bw_est_mode")
                .long("bw_est_mode")
                .default_value("true")
                .help(""),
        )
        .arg(
            Arg::with_name("delay_threshold")
                .long("delay_threshold")
                .default_value("1.25")
                .help(""),
        )
        .arg(
            Arg::with_name("xtcp_flows")
                .long("xtcp_flows")
                .default_value("2")
                .help(""),
        )
        .arg(
            Arg::with_name("init_delay_threshold")
        ...
        .arg(
            Arg::with_name("pulse_size")
                .long("pulse_size")
                .default_value("0.25")
                .help(""),
        )
        .arg(
            Arg::with_name("switching_thresh")
                .long("switching_thresh")
                .default_value("0.4")
                .help(""),
        )
        .arg(
            Arg::with_name("flow_mode")
                .long("flow_mode")
        ...
        .arg(
            Arg::with_name("use_ewma")
                .long("use_ewma")
                .default_value("false")
                .help(""),
        )
        .arg(
            Arg::with_name("set_win_cap")
                .long("set_win_cap")
                .default_value("false")
                .help(""),
        )
